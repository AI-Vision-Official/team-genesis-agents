...
import { Image, Download, Share, RefreshCw, Palette, Zap } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className={`text-gray-600 mt-1 ${settings.dyslexiaFont ? 'font-mono' : ''}`}>
            AI-powered image generation with instant previews
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your image generation history and favorites</CardDescription>
        </CardHeader>
        <CardContent>
